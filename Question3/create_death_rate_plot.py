...
(Previously create_ON_phu_cases_plot.py)
  ...
  Functional Summary
      create_death_rate_plot.py reads a CSV file and saves
...
def main(argv):
  ...
  #
  if len(argv) != 3:
      print("Usage:","python Question3/create_death_rate_plot.py <data file> <graphics file> ")
      sys.exit(-1)
  ...
  ax = sns.lineplot(x = "Date", y = "Death Rate (%)", data=csv_df)
